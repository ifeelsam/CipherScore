...
pub mod cipher_score {
    ...
    pub fn init_comp_defs(ctx: Context<InitCompDefs>) -> Result<()> {
        ...
        init_comp_def(
            ...
            hash: [0x63, 0xef, 0x02, 0xd9, 0x52, 0xfd, 0x32, 0xa7, 0x7c, 0x6c, 0x4f, 0x7c, 0x1c, 0x23, 0x1b, 0xd3, 0xae, 0xe9, 0x65, 0xf9, 0x33, 0xdb, 0xde, 0xa7, 0x19, 0x03, 0x38, 0x3b, 0x53, 0xcf, 0x23, 0x06],
            })),
            None,
        )?;
