...
{`POST ${backendBaseUrl}/calculate_credit_score
...
{`{
  ...
  "sol_balance": 100000000
            ...
            >
              ...
              <pre className="mt-3 overflow-x-auto rounded-2xl p-4 text-xs" style={{ background: "#0F0F0F", border: "1px solid rgba(255,255,255,0.06)", color: "#EDEDED" }}>
{`GET ${backendBaseUrl}/wallet_status/<WALLET_ADDRESS>
X-API-Key: <YOUR_API_KEY>
...
# Response includes: account_exists, current_score, risk_level, cooldown_status`}
            ...
            >
              ...
              <pre className="mt-3 overflow-x-auto rounded-2xl p-4 text-xs" style={{ background: "#0F0F0F", border: "1px solid rgba(255,255,255,0.06)", color: "#EDEDED" }}>
{`GET ${backendBaseUrl}/dashboard/api-keys/stats/usage
...
# Response includes: totalRequests, endpointStats, monthlyUsage { used, limit, remaining, resetDate }`}
            ...
            <div
              ...
              style={{ background: "#1A1A1A", border: "1px solid rgba(255,255,255,0.06)" }}
            >
              <h3 className="text-lg font-medium text-white">SDK</h3>
              <p className="mt-2 text-sm text-white/70">Use the local TypeScript SDK for a simple client integration.</p>
              <pre className="mt-3 overflow-x-auto rounded-2xl p-4 text-xs" style={{ background: "#0F0F0F", border: "1px solid rgba(255,255,255,0.06)", color: "#EDEDED" }}>
...
await sdk.walletStatus('<SOLANA_WALLET_ADDRESS>')`}
            ...
            <div
              ...
              style={{ background: "#1A1A1A", border: "1px solid rgba(255,255,255,0.06)" }}
            >
              <h3 className="text-lg font-medium text-white">Modes</h3>
