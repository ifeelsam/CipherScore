...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <div className={cn("relative flex items-center py-3", collapsed ? "px-1" : "px-3 justify-between")}> 
        <Link
          href="/"
          className={cn(
            ...
            collapsed ? "w-full justify-center gap-0 px-0 py-1" : "gap-2 px-2 py-1 hover:bg-white/5",
          )}
        >
          {/* Logo */}
      ...
      <nav className="mt-2 px-2">
        <ul className="space-y-1">
          ...
          <NavItem href="/usage" label="Usage" icon={BarChart3} collapsed={collapsed} />
